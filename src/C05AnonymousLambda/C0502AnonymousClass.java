...
//        실행문이 2줄 이상인 경우에는 아래와 같이 {}로 감싸야함에 유의
        Animal1 ai2 = ()-> {
...
//        실습 : Animal3 인터페이스 정의, makeSound 함수 (매개변수는 String,String, int. 리턴타입은 String)
//        구현체의 기능은, a,b,c중에 c가 10이상이면 a+b를 리턴. c가 10보다 작으면 a를 리턴
        ...
        System.out.println(animal3.makeSound("a","b",11));
        System.out.println(animal3.makeSound("a","b",8));
    }
}
